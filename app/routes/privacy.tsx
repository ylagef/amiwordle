...
export const meta: MetaFunction = () => {
  return {
    title: "Amiwordle · Política de privacidad",
  };
};
...
export default function Privacy() {
  return (
    <div className="privacy-container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Amiwordle.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Amiwordle, accessible from{" "}
            <a
              href="www.amiwordle.netlify.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.amiwordle.netlify.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: amiwordle@gmail.com</li>
      </ul>
    </div>
  );
}
